...
public class TourOperatorController(ITourOperatorService service) : ControllerBase
{
    [HttpGet]
    ...
    public async Task<IActionResult> Create([FromBody] CreateTourOperatorDto dto, CancellationToken ct)
    { 
    ...
    public async Task<IActionResult> Update(int id, [FromBody] UpdateTourOperatorDto dto, CancellationToken ct)
    {
