...
public class NumberTypeController(INumberTypeService service) : ControllerBase
{
    [HttpGet]
    ...
    public async Task<IActionResult> Create([FromBody] CreateNumberTypeDto dto, CancellationToken ct)
    {
    ...
    public async Task<IActionResult> Update(int id, [FromBody] UpdateNumberTypeDto dto, CancellationToken ct)
    {
