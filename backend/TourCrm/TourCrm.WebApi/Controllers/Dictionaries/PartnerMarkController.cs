...
public class PartnerMarkController(IPartnerMarkService service) : ControllerBase
{
    [HttpGet]
    ...
    public async Task<IActionResult> Create([FromBody] CreatePartnerMarkDto dto, CancellationToken ct)
    {
    ...
    public async Task<IActionResult> Update(int id, [FromBody] UpdatePartnerMarkDto dto, CancellationToken ct)
    {
