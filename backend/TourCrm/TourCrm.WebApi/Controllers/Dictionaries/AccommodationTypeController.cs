...
public class AccommodationTypeController(IAccommodationTypeService service) : ControllerBase
{
    [HttpGet]
    ...
    public async Task<IActionResult> Create([FromBody] CreateAccommodationTypeDto dto, CancellationToken ct)
    {
    ...
    public async Task<IActionResult> Update(int id, [FromBody] UpdateAccommodationTypeDto dto, CancellationToken ct)
    {
