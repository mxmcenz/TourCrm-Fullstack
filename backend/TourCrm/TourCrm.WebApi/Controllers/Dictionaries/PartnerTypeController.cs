...
public class PartnerTypeController(IPartnerTypeService service) : ControllerBase
{
    [HttpGet]
    ...
    public async Task<IActionResult> Create([FromBody] CreatePartnerTypeDto dto, CancellationToken ct)
    {
    ...
    public async Task<IActionResult> Update(int id, [FromBody] UpdatePartnerTypeDto dto, CancellationToken ct)
    {
