...
public class MealTypeController(IMealTypeService service) : ControllerBase
{
    [HttpGet]
    ...
    public async Task<IActionResult> Create([FromBody] CreateMealTypeDto dto, CancellationToken ct)
    {
    ...
    public async Task<IActionResult> Update(int id, [FromBody] UpdateMealTypeDto dto, CancellationToken ct)
    {
