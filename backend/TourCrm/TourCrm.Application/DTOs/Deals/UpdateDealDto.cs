...
public record UpdateDealDto
{
    ...
    public IReadOnlyList<NewCustomerDto>? Customers { get; init; }
    public IReadOnlyList<NewTouristDto>? Tourists { get; init; }
    public IReadOnlyList<NewServiceDto>? Services { get; init; }
    public IReadOnlyList<NewPaymentDto>? ClientPays { get; init; }
    public IReadOnlyList<NewPaymentDto>? PartnerPays { get; init; }
}